...
void main() {
  ...
  group('Scroll to index after the item count changed', () {
    ...
    const double viewportHeight = 360;
    ...
    Future<void> testJumpToTheLastIndex(
      ...
      required double realMaxScrollExtent,
    }) async {
    ...
    testWidgets('Jump to the last index in ListView', (tester) async {
      await testJumpToTheLastIndex(
        tester,
        isSeparated: false,
        realMaxScrollExtent: 40 * itemHeight - viewportHeight,
      );
    });

    testWidgets('Jump to the last index in separated ListView', (tester) async {
      await testJumpToTheLastIndex(
        tester,
        isSeparated: true,
        realMaxScrollExtent:
            40 * itemHeight + 39 * separatorHeight - viewportHeight,
      );
    });
  });
